...
export const UsersScreen = () => {
    ...
    const columns: GridColDef[] = [
        ...
        { field: "lastlogin",   headerName: t("lastlogin"),   width: 240 },
        ...
        { field: "roleid",      headerName: t("roleid"),      width: 120 },
        { field: "customrole",  headerName: t("customrole"),  width: 240 },
        { field: "disabled",    headerName: t("disabled"),    width: 180 },
        { field: "licensetype", headerName: t("licensetype"), width: 180 },
        { field: "usertype",    headerName: t("usertype"),    width: 180 },
        { field: "access",      headerName: t("access"),      width: 180 },
        { field: "storeage",    headerName: t("storeage"),    width: 180 },
        { field: "itemcount",   headerName: t("itemcount"),   width: 180 },
        { field: "groupcount",  headerName: t("groupcount"),  width: 200 },
        { field: "adstatus",    headerName: t("adstatus"),    width: 200 },
